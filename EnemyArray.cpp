...
void EnemyArray_Type1(vector<Enemy*> &EnemyArray,SDL_Renderer* screen)
{
    ...
    for(int i=0;i<Num_of_ThreatArray1;i++)
    {
        ...
        p_enemy2->set_x_pos(SCREEN_WIDTH/2-(p_enemy2->get_width_frame())/2+100*(i-2));
        p_enemy2->set_y_limit(300);
        p_enemy2->set_y_pos(-75-25*i);
...
void EnemyArray_Type2(vector<Enemy*> &EnemyArray,SDL_Renderer* screen)
{
    for(int i=0;i<Num_of_ThreatArray2;i++)
    {
        ...
        p_enemy1->set_y_pos(SCREEN_HEIGHT/3-(p_enemy1->get_height_frame())/2+100*(i-1.5));
        EnemyArray.push_back(p_enemy1);
    }
    for(int i=0;i<Num_of_ThreatArray2;i++)
    {
        ...
        p_enemy2->set_y_pos(SCREEN_HEIGHT/3-(p_enemy2->get_height_frame())/2+100*(i-1.5));
        EnemyArray.push_back(p_enemy2);
    }
}
void EnemyArray_Type3(vector<Enemy*> &EnemyArray,SDL_Renderer* screen)
{
    for(int i=0;i<Num_of_ThreatArray3;i++)
    {
        ...
        p_enemy->set_x_pos(SCREEN_WIDTH/2-(p_enemy->get_width_frame())/2+200*(i-0.5));
...
void EnemyArray_Type4(vector<Enemy*> &EnemyArray,SDL_Renderer* screen)
{
    for(int i=0;i<Num_of_ThreatArray4;i++)
    {
        ...
        p_enemy->set_stats(screen);
        p_enemy->set_x_pos(rand()%(650-p_enemy->get_width_frame()-150+1)+150);
...
void EnemyArray_Type5(vector<Enemy*> &EnemyArray,SDL_Renderer* screen)
{
    for(double i=0;i<Num_of_ThreatArray5;i++)
    {
        for(double j=0;j<Num_of_ThreatArray5-i;j++)
        {
            ...
            p_enemy->set_stats(screen);
            p_enemy->set_x_pos(SCREEN_WIDTH/2-(p_enemy->get_width_frame())/2+200*(j-(3-i)/2+0.5));
            p_enemy->set_y_limit(100+100*i);
            p_enemy->set_y_pos(-85*3+85*i);
            EnemyArray.push_back(p_enemy);
        }
    }
}
void EnemyArray_Type6(vector<Enemy*> &EnemyArray,SDL_Renderer* screen)
{
    for(int i=0;i<4;i++)
    {
        ...
        if(i%2==0)
        {
            p_enemy->set_x_pos(SCREEN_WIDTH/2-(p_enemy->get_width_frame())/2+100*(i-1));
        ...
        else
        {
            ...
            p_enemy->set_y_pos(-p_enemy->get_height_frame()+100*(i-2));
...
void EnemyArray_Type7(vector<Enemy*> &EnemyArray,SDL_Renderer* screen)
{
    for(int i=0;i<2;i++)
    {
        for(int j=0;j<4;j++)
        {
            ...
            if(j%2==0)
            {
                p_enemy->set_x_pos(SCREEN_WIDTH/2-(p_enemy->get_width_frame())/2+100*(j-1)+400*(i-0.5));
                p_enemy->set_y_pos(-p_enemy->get_height_frame());
                p_enemy->set_y_limit(200);
            }
            else
            {
                p_enemy->set_x_pos(SCREEN_WIDTH/2-(p_enemy->get_width_frame())/2+400*(i-0.5));
                p_enemy->set_y_pos(-p_enemy->get_height_frame()+100*(j-2));
